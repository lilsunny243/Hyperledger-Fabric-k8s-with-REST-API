...
assetsRouter.post(
  ...
  body('hostname', 'must be a string').notEmpty(),
  body('ip', 'must be a string').notEmpty(),
  body('ttl', 'must be a string').notEmpty(),
  body('time', 'must be a string').notEmpty(),
  ...
  async (req: Request, res: Response) => {
    ...
    const mspId = req.user as string;
    const assetId = req.body.hostname;
